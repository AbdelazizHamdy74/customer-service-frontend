...
const STAFF_DASHBOARDS: Record<string, DashboardPreset> = {
  ADMIN: {
    ...
    quickActions: [
      ...
      },
      {
        ...
        description: 'Register a new account with contact and address details.',
        route: 'customers/new',
        badge: 'Fast path',
      ...
      },
      {
        ...
        description: 'Open the reports area to inspect team-wide service trends.',
        route: 'reports',
        badge: 'Preview',
    ...
    focusList: [
      ...
      'Use the reports module as the next expansion point after customers and dashboard.',
  ...
  SUPERVISOR: {
    ...
    quickActions: [
      ...
      {
        title: 'Create customer',
        description: 'Add a new record when the team receives a first-time contact.',
        route: 'customers/new',
        badge: 'Quick add',
        accent: 'from-emerald-600 to-teal-600',
      },
      {
        title: 'Team board',
        description: 'Open the placeholder team board and keep navigation ready for expansion.',
        route: 'team',
        badge: 'Preview',
        accent: 'from-slate-700 to-slate-900',
      },
    ...
    focusList: [
      ...
      'Treat the team and reports links as connected next steps in the UI roadmap.',
    ],
  },
  AGENT: {
